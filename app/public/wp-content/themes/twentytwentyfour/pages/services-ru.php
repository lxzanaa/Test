...
<section class="bg-[#141415] pt-16 pb-16">
    <div class="max-w-[1322px] mx-auto px-5">
      ...
      <h1
        class="md:text-[64px] text-4xl font-semibold text-white  text-center mb-24 relative after:text-[#141415] after:content-['УСЛУГИ'] after:absolute after:top-1/2 after:left-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:block after:text-[68px] md:after:text-[128px] after:z-10 uppercase">
        <span class="relative z-30">УСЛУГИ</span>
      </h1>
