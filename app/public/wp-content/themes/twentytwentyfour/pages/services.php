...
<section class="bg-[#141415] pt-16 pb-16">
    <div class="max-w-[1322px] mx-auto px-5">
      ...
      <h1
        class="md:text-[64px] text-4xl font-semibold text-white  text-center mb-24 relative after:text-[#141415] after:content-['Xizmatlar'] after:absolute after:top-1/2 after:left-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:block after:text-[68px] md:after:text-[128px] after:z-10 uppercase">
        <span class="relative z-30">Xizmatlar</span>
      </h1>
      <div class="grid lg:grid-cols-3 gap-5 md:grid-cols-2 grid-cols-1">
        <div style="background-image: linear-gradient(180deg, #252527 30.75%, rgba(1, 134, 239, 0.00) 615.25%);"
          class="p-8 pr-9 pb-5 relative overflow-hidden rounded-lg flex flex-col hover:shadow-[0 0 10px #0086EE4D]">
          <svg class="absolute bottom-3 right-0 inline-block" xmlns="http://www.w3.org/2000/svg" width="202"
            height="179" viewBox="0 0 202 179" fill="none">
            <g filter="url(#filter0_f_653_1971)">
              <circle cx="110" cy="110" r="55" fill="#0086EE" fill-opacity="0.3" />
            </g>
            <defs>
              <filter id="filter0_f_653_1971" x="0" y="0" width="220" height="220" filterUnits="userSpaceOnUse"
          ...
          <p class="text-sm text-white leading-snug mb-[56px]">Oddiy so‘zlar bilan aytganda, foydalanuvchi interfeys bilan qanday aloqada bo‘lishi va sayt yoki dastur ular uchun qanchalik qulay ekanligi. Ux / UI dizaynerlari IT sohasida talabga ega, chunki dasturchilar tayyorlaydigan interfeyslar nafaqat chiroyli, balki tushunarli bo‘lishi kerak.</p>
          <div class="flex gap-2 relative z-10 mt-auto">
            <a href="#contact"
              class="px-[14px] py-3 bg-[#0086EE] rounded-lg font-bold text-sm  text-white border border-transparent hover:border-[#0086EE] hover:bg-transparent transition-all">Buyurtma
              berish</a>
            <a href="/about/"
              class="px-[14px] py-3 border border-[#0086EE] rounded-lg font-bold text-sm  text-[#0086EE] hover:bg-white transition-all">Batafsil</a>
          </div>

        </div>
        <div style="background-image: linear-gradient(180deg, #252527 30.75%, rgba(1, 134, 239, 0.00) 615.25%);"
          class="p-8 pr-9 pb-5 relative overflow-hidden rounded-lg flex flex-col">
          <svg class="absolute bottom-3 right-0 inline-block" xmlns="http://www.w3.org/2000/svg" width="202"
            height="179" viewBox="0 0 202 179" fill="none">
            <g filter="url(#filter0_f_653_1971)">
              <circle cx="110" cy="110" r="55" fill="#0086EE" fill-opacity="0.3" />
          ...
          <p class="text-sm text-white leading-snug mb-[56px]">Grafik dizayn-uyg‘un va samarali vizual-aloqa muhitini yaratish bo‘yicha badiiy va dizayn faoliyati. Boshqa tomondan, grafik dizayn bu maʼlumotni taqdim etish uchun matn, rasm yoki xabarni targ‘ib qilish yordamida vizual aloqa shakli.</p>
          <div class="flex gap-2 relative z-10 mt-auto">
            <a href="#contact"
              class="px-[14px] py-3 bg-[#0086EE] rounded-lg font-bold text-sm  text-white border border-transparent hover:border-[#0086EE] hover:bg-transparent transition-all">Buyurtma
              berish</a>
        ...
        <div style="background-image: linear-gradient(180deg, #252527 30.75%, rgba(1, 134, 239, 0.00) 615.25%);"
          ...
          <p class="text-sm text-white leading-snug mb-[56px]">SMM — ijtimoiy media marketingini anglatadi. SMM ning maqsadi Telegram, VKontakte, Facebook, Instagram va boshqa ijtimoiy saytlardan mijozlarni jalb qilishdir. SMMning yana bir muhim vazifasi brend xabardorligini oshirish va obro ʼ — eʼtibori ustida ishlashdir.</p>
          <div class="flex gap-2 relative z-10 mt-auto">
            <a href="#contact"
              class="px-[14px] py-3 bg-[#0086EE] rounded-lg font-bold text-sm  text-white border border-transparent hover:border-[#0086EE] hover:bg-transparent transition-all">Buyurtma
              berish</a>
        ...
        <div style="background-image: linear-gradient(180deg, #252527 30.75%, rgba(1, 134, 239, 0.00) 615.25%);"
          ...
          <p class="text-sm text-white leading-snug mb-[56px]">Promo video — bu mahsulotni sotishga qaratilgan video. U mahsulot, xizmat yoki xizmatning raqobatchilarga nisbatan afzalliklarini yetkazish yoki mahsulotga bo‘lgan ehtiyojni isteʼmolchiga ko‘rsatish uchun ishlatiladi. Shunday qilib, reklama-bu potensial isteʼmolchiga taʼsir qilish uchun eng muhim maʼlumotlarni video formatida taqdim etadigan kompaniya, mahsulot yoki xizmat uchun reklama.</p>
          <div class="flex gap-2 relative z-10 mt-auto">
            <a href="#contact"
              class="px-[14px] py-3 bg-[#0086EE] rounded-lg font-bold text-sm  text-white border border-transparent hover:border-[#0086EE] hover:bg-transparent transition-all">Buyurtma
              berish</a>
        ...
        <div style="background-image: linear-gradient(180deg, #252527 30.75%, rgba(1, 134, 239, 0.00) 615.25%);"
          ...
          <p class="text-sm text-white leading-snug mb-[56px]">Motion design-bu estetik va jozibali vizual echimlarni yaratish uchun animatsiya, video tahrirlash va boshqa texnikaning asoslarini birlashtirgan dizayn sohasi.</p>
          <div class="flex gap-2 relative z-10 mt-auto">
            <a href="#contact"
              class="px-[14px] py-3 bg-[#0086EE] rounded-lg font-bold text-sm  text-white border border-transparent hover:border-[#0086EE] hover:bg-transparent transition-all">Buyurtma
              berish</a>
        ...
        <div style="background-image: linear-gradient(180deg, #252527 30.75%, rgba(1, 134, 239, 0.00) 615.25%);"
          ...
          <p class="text-sm text-white leading-snug mb-[56px]">Video montaj-bu bitta va bitta asarga olib keladigan video materiallarni qayta ishlash jarayoni: film, video, teleko‘rsatuv, musiqiy video yoki reklama. Kino va video ishlab chiqarishda montaj qilish suratga olish jarayonining o‘zi kabi muhimdir. O‘rnatish tufayli siz kerakli atmosfera va hikoya ritmini o‘rnatishingiz mumkin.</p>
          <div class="flex gap-2 relative z-10 mt-auto">
            <a href="#contact"
              class="px-[14px] py-3 bg-[#0086EE] rounded-lg font-bold text-sm  text-white border border-transparent hover:border-[#0086EE] hover:bg-transparent transition-all">Buyurtma
              berish</a>
        ...
        <div style="background-image: linear-gradient(180deg, #252527 30.75%, rgba(1, 134, 239, 0.00) 615.25%);"
          ...
          <p class="text-sm text-white leading-snug mb-[56px]">Telegram botlar — bu messenjer ichidagi mini dasturlar bo‘lib, ular suhbatdagi matn buyruqlari tomonidan savol-javob asosida boshqariladi. Bu turdagi botlar sizga yana-da qulaylik beradi va vaqtingizni tejashga sabab bo‘ladi.</p>
          <div class="flex gap-2 relative z-10 mt-auto">
            <a href="#contact"
              class="px-[14px] py-3 bg-[#0086EE] rounded-lg font-bold text-sm  text-white border border-transparent hover:border-[#0086EE] hover:bg-transparent transition-all">Buyurtma
              berish</a>
        ...
        <div style="background-image: linear-gradient(180deg, #252527 30.75%, rgba(1, 134, 239, 0.00) 615.25%);"
          ...
          <p class="text-sm text-white leading-snug mb-[56px]">Web dasturlash - bu internetda ishlaydigan saytlar va xizmatlarni ishlab chiqish. Masalan, do‘konlar, axborot resurslari, ochilish sahifalari, onlayn kinoteatrlar, forumlar.</p>
          <div class="flex gap-2 relative z-10 mt-auto">
            <a href="#contact"
              class="px-[14px] py-3 bg-[#0086EE] rounded-lg font-bold text-sm  text-white border border-transparent hover:border-[#0086EE] hover:bg-transparent transition-all">Buyurtma
              berish</a>
        ...
        <div style="background-image: linear-gradient(180deg, #252527 30.75%, rgba(1, 134, 239, 0.00) 615.25%);"
          ...
          <p class="text-sm text-white leading-snug mb-[56px]">Mobil dasturlar - bu sizning smartfoningizda (IOS| ANDROID) ish faoliyatida bo'lgan xar-xil turdagi ilovalar, oyin, elektron kitob va boshqa turdagi dasturlardur!</p>
          <div class="flex gap-2 relative z-10 mt-auto">
            <a href="#contact"
              class="px-[14px] py-3 bg-[#0086EE] rounded-lg font-bold text-sm  text-white border border-transparent hover:border-[#0086EE] hover:bg-transparent transition-all">Buyurtma
              berish</a>
        ...
        <div style="background-image: linear-gradient(180deg, #252527 30.75%, rgba(1, 134, 239, 0.00) 615.25%);"
          ...
          <p class="text-sm text-white leading-snug mb-[56px]">SEO (Search Engine Optimization-qidiruv tizimlari uchun saytni optimallashtirish) - bu qidiruv tizimlari uchun sayt ahamiyatini oshirishga yordam beradigan usullar to‘plami. O‘z mohiyatiga ko‘ra, SEO-bu saytni top-10da reklama qilish uchun tavsiya etilgan bir qator vazifalar jamlanmasidir. Bu yangi auditoriyani jalb qilishga imkon.</p>
          <div class="flex gap-2 relative z-10 mt-auto">
            <a href="#contact"
              class="px-[14px] py-3 bg-[#0086EE] rounded-lg font-bold text-sm  text-white border border-transparent hover:border-[#0086EE] hover:bg-transparent transition-all">Buyurtma
              berish</a>
        ...
        <div style="background-image: linear-gradient(180deg, #252527 30.75%, rgba(1, 134, 239, 0.00) 615.25%);"
          ...
          <p class="text-sm text-white leading-snug mb-[56px]">Targeting - bu tarmoqning barcha foydalanuvchilaridan CA-ni ma'lum mezonlarga muvofiq ajratib olish va RC-dan maksimal ta'sirga erishish uchun o'z mahsulotlarini reklama qilish imkonini beradigan marketing mexanizmi xisoblanadi . Maqsad CA uchun reklama xabarini yaratish va uning samaradorligini oshirishdir</p>
          <div class="flex gap-2 relative z-10 mt-auto">
            <a href="#contact"
              class="px-[14px] py-3 bg-[#0086EE] rounded-lg font-bold text-sm  text-white border border-transparent hover:border-[#0086EE] hover:bg-transparent transition-all">Buyurtma
              berish</a>
        ...
        <div style="background-image: linear-gradient(180deg, #252527 30.75%, rgba(1, 134, 239, 0.00) 615.25%);"
          ...
          <p class="text-sm text-white leading-snug mb-[56px]">Marketing - tashkiliy funksiya va xaridorlarga mahsulot yoki xizmatni yaratish, targ‘ib qilish va taqdim etish va ular bilan munosabatlarni tashkilot uchun foyda bilan boshqarish hisoblanadi.</p>
          <div class="flex gap-2 relative z-10 mt-auto">
            <a href="#contact"
              class="px-[14px] py-3 bg-[#0086EE] rounded-lg font-bold text-sm  text-white border border-transparent hover:border-[#0086EE] hover:bg-transparent transition-all">Buyurtma
              berish</a>
